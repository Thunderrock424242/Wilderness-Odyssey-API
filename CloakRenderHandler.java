...
public class CloakRenderHandler {
  ...
  //     float pitch = -player.getXRot();
        ...
        tempCamera.getPosition();
        tempCamera.rotation();
        tempCamera.setup(mc.level, player, false, false, mc.getFrameTimeNs());
        ...
        // Get the real camera from the game renderer
        Camera camera = mc.gameRenderer.getMainCamera();

        // Prepare a PoseStack to get the view matrix
