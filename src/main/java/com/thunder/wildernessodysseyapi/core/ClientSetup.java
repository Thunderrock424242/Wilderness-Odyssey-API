...
import com.thunder.wildernessodysseyapi.cryo.client.CryoTubeOccupantRenderer;
...
public class ClientSetup {
    ...
    public static void onRegisterRenderers(EntityRenderersEvent.RegisterRenderers event) {
        ...
        event.registerEntityRenderer(ModEntities.RIFTBORN.get(), RiftbornRenderer::new);
        ...
        event.registerBlockEntityRenderer(CryoTubeBlock.CRYO_TUBE_ENTITY.get(), CryoTubeOccupantRenderer::new);
