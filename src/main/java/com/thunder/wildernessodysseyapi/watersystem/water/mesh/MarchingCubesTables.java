 ...
 * MarchingCubesTables
 *
 * The two standard look-up tables used by the Marching Cubes algorithm:
 *
 *   EDGE_TABLE  — bitmask of which edges are intersected for each of the
 *                 256 possible cube corner sign combinations
 *
 *   TRI_TABLE   — for each of the 256 cases, up to 5 triangles described
 *                 as edge indices (terminated by -1)
 *
 * These are the canonical Lorensen & Cline (1987) tables.
 */
