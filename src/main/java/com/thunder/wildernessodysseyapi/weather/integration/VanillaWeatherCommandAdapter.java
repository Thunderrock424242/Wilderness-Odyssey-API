...
public final class VanillaWeatherCommandAdapter {
    ...
    /**
     * Applies one vanilla command state without discarding local temperature or
     * wind. Cold atmospheric cells therefore turn vanilla rain into snow.
     */
    ...
    private static WeatherSample precipitation(
        ...
        PrecipitationType type = old.temperature() <= WeatherSample.SNOW_MAX_TEMPERATURE
