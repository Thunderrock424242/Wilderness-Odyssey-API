...
2. Start the separate Java 21 service: `java -jar Aether-AI-Server.jar --config aether-server.yml`.
3. Configure Minecraft to use `http://127.0.0.1:8085` with a matching bearer credential.
